;(function (window) {
  ...
  function timeElapse(date){
    ...
    return result = "相识 " + days + " 天 " + hours + " 时 " + minutes + " 分";// + seconds + " 秒"; 
  }
  let xs_date='2022-11-04 22:28:00'
  var xj_date=timeElapse(xs_date)
  let texts = ['缘来天注定', '一切刚刚好，恰好遇到你', '强烈的心动', '不顾一切的想要奔向你', '想要余生都守护你', '陪你开心，陪你难过', '陪你浪漫，陪你现实', '接起缘分，呵护一生', '我们相识', '也终将会相知相伴', '我喜欢你', '余生，全都是你', xj_date]
